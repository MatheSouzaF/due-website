...
<section class="single-empreendimentos">
    ...
    <div class="hero-single-empreendimentos">
        ...
        <div class="box-video">
            <video class="video-hero" autoplay="autoplay" src="<?php echo get_field('video_horizontal_do_empreendimento') ?>" muted loop play></video>
            ...
            <div class="box-container introducao-ancora">
                <div class="box-repetidor-ancora">
                    ...
                    if (have_rows('links_ancoras')) :
                        while (have_rows('links_ancoras')) : the_row(); ?>
                            <?php
                ...
                <div class="box-textos-introducao">
                    ...
                    <p class="founders-grotesk subtitulo-introducao"><?php echo get_field('paragrafo_introducao'); ?></p>
                </div>
            </div>
            <div class="box-container introducao-valores">
                ...
                <div class="repetidor-valores">
                    ...
                    if (have_rows('box_valores')) :
                        while (have_rows('box_valores')) : the_row(); ?>
                            <div class="box-valores">
                                <h4 class="box-titulo-valores founders-grotesk"><?php echo get_sub_field('titulo_valores'); ?></h4>
                                <p class="subtitulo-valores founders-grotesk"><?php echo get_sub_field('subtitulo_valores'); ?></p>
                            </div>
                    <?php endwhile;
                    endif; ?>
                </div>
                ...
                <div class="topicos-destaque">
                    ...
                    if (have_rows('topicos_destaque')) :
                        while (have_rows('topicos_destaque')) : the_row(); ?>
                            <div class="box-destaque">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                    <path d="M7.66667 11.8333L10.1667 14.3333L14.3333 8.5M21 11C21 12.3132 20.7413 13.6136 20.2388 14.8268C19.7363 16.0401 18.9997 17.1425 18.0711 18.0711C17.1425 18.9997 16.0401 19.7363 14.8268 20.2388C13.6136 20.7413 12.3132 21 11 21C9.68678 21 8.38642 20.7413 7.17317 20.2388C5.95991 19.7363 4.85752 18.9997 3.92893 18.0711C3.00035 17.1425 2.26375 16.0401 1.7612 14.8268C1.25866 13.6136 1 12.3132 1 11C1 8.34784 2.05357 5.8043 3.92893 3.92893C5.8043 2.05357 8.34784 1 11 1C13.6522 1 16.1957 2.05357 18.0711 3.92893C19.9464 5.8043 21 8.34784 21 11Z" stroke="#002B36" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
    ...
    <div class="praia" id="praia">
        <div class="wrapper">
            ...
            <div class="box-video">
                <video class="video-praia" autoplay="autoplay" src="<?php echo get_field('video_praia') ?>" muted loop play></video>
            ...
            <div class="box-cards-praia">
                ...
                if (have_rows('cards_infos_praia')) :
                    $counter = 1;
                    while (have_rows('cards_infos_praia')) : the_row();
                    ...
                    if (have_rows('caracteristicas')) :
                        while (have_rows('caracteristicas')) : the_row(); ?>
                            <div class="row-caracteristicas">
                                ...
                                <p class="texto-caracteristica founders-grotesk"><?php echo get_sub_field('texto_da_caracteristica'); ?></p>
                            </div>
                    <?php endwhile;
                    endif; ?>
                </div>
                        ...
                        while (have_rows('imagens')) : the_row();
                            if ($index % 2 !== 0) : // Ímpar
                                ...
                                if ($image) :
                                    $image_url = $image['url'];
                                    $image_alt = $image['alt']; ?>
                                    <a class="img" style="height: <?php echo get_sub_field('altura_da_imagem') ?>;" href="<?php echo esc_url($image_url); ?>" data-fancybox data-caption="<?php echo esc_attr($image_alt); ?>">
                            ...
                            while (have_rows('imagens')) : the_row(); ?>
                                <div class="swiper-slide">
                                    ...
                                    if ($image) :
                                        $image_url = $image['url'];
                                        $image_alt = $image['alt']; ?>
                                        <a class="img" href="<?php echo esc_url($image_url); ?>" data-fancybox="gallery" data-caption="<?php echo esc_attr($image_alt); ?>">
                                            <img class="imgGrow" src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($image_alt); ?>">
                                        </a>
                                    <?php endif; ?>
                                </div>
    ...
    <div class="informacoes-obra">
        <div class="wrapper">
            <div class="box-infos-obra box-titulos">
                <h3 class="titulo-infos-obra terminal-test"><?php echo get_field('titulo_informacoes_tecnicas_da_obra'); ?></h3>
                <p class="descricao-infos-obra founders-grotesk"><?php echo get_field('descricao_informacoes_tecnicas_da_obra'); ?></p>
            </div>
            <div class="box-infos-obra box-autores">
                <?php
                if (have_rows('autores_informacoes_tecnicas_da_obra')) :
                    while (have_rows('autores_informacoes_tecnicas_da_obra')) : the_row(); ?>
                        <div class="row-autores">
                            <h4 class="titulo-autores founders-grotesk"><?php echo get_sub_field('titulo_autores_informacoes_tecnicas_da_obra'); ?></h4>
                            <?php
                            if (have_rows('autor_informacoes_tecnicas_da_obra')) :
                                while (have_rows('autor_informacoes_tecnicas_da_obra')) : the_row(); ?>
                                    <p class="text-autor founders-grotesk"><?php echo get_sub_field('texto_autor_informacoes_tecnicas_da_obra'); ?></p>
                            <?php endwhile;
                            endif; ?>
                        </div>
                <?php endwhile;
