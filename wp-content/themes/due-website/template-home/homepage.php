...
<section class="banner-hero">
    ...
    <div class="box-busca-banner-hero">
            ...
            <div class="box-svg">
                ...
                <div class="select">
                    ...
                    <label for="checkbox-2">
                        <input value="2" id="checkbox-2" type="checkbox">
                        Checkbox #2
                    </label>
                    <label for="checkbox-3">
                        <input value="3" id="checkbox-3" type="checkbox">
                        Checkbox #3
                    </label>
                    <label for="checkbox-4">
                        <input value="4" id="checkbox-4" type="checkbox">
                        Checkbox #4
                    </label>
                    <label for="checkbox-5">
                        <input value="5" id="checkbox-5" checked="checked" type="checkbox">
                        Checkbox #5
                    </label>
                    <label for="checkbox-6">
                        <input value="8" id="checkbox-6" type="checkbox">
                        Checkbox #6
                    </label>
                </div>
            </div>
