...
<section class="page-iniciativas">
        ...
        <div class="container-banner">
            <div class="box-titulo">
                <div class="container-text">
                    ...
                    <h1 class="titulo-banner-inciativas terminal-test">
                        <?php echo get_field('titulo_banner_iniciativas'); ?></h1>
                    <p class="descricao-banner-inciativas founders-grotesk">
                        <?php echo get_field('descricao_banner_iniciativas'); ?></p>
                </div>
    ...
    <?php
    $titulo = get_field('titulo_instituto_neymar');
    ...
    <section class="instituto-neymar" id="instituto-neymar">
        ...
        <div class="box-conteudo-left">
            ...
            <h2 class="titulo-instituto-neymar terminal-test"><?php echo esc_html($titulo); ?></h2>
            ...
            <?php
                ...
                ?>
            <a class="button link-instituto-neymar-desktop gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
        ...
        <div class="box-conteudo-right box-conteudo-right-instituto-neymar">
            <?php
                ...
                if ($image) :
                    $image_url = $image['url'];
                    $image_alt = $image['alt']; ?>
            <img class="image-instituto-neymar" src="<?php echo esc_url($image_url); ?>"
            ...
            <?php
                if ($link) :
                ?>
            <a class="button link-instituto-neymar-mobile gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
    ...
    <section class="vila-alafia" id="vila-alafia">
        ...
        <div class="box-conteudo-left">
            ...
            if ($link) :
                ...
                $gtm_link_associacao = strtolower(str_replace(' ', '-', $link_title));
            ?>
            <a class="button link-vila-alafia-desktop gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
        ...
        <div class="box-conteudo-right box-conteudo-right-vila-alafia">
            ...
            if ($image) :
                $image_url = $image['url'];
                $image_alt = $image['alt']; ?>
            <img class="image-vila-alafia" src="<?php echo esc_url($image_url); ?>"
                alt="<?php echo esc_attr($image_alt); ?>">
            <?php endif; ?>
            <?php
            $link = get_field('link_vila_alafia');
            ...
            ?>
            <a class="button link-vila-alafia-mobile gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
    ...
    <section class="instituto-padre-arlindo" id="instituto-padre-arlindo">
        ...
        <div class="box-conteudo-left">
            ...
            <h2 class="titulo-instituto-padre-arlindo terminal-test">
                <?php echo get_field('titulo_instituto_padre_arlindo'); ?></h2>
            <div class="descricao-instituto-padre-arlindo"><?php echo get_field('descricao_instituto_padre_arlindo'); ?>
            </div>
            <?php
            ...
            ?>
            <a class="button link-instituto-padre-arlindo-desktop gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
        ...
        <div class="box-conteudo-right box-conteudo-right-instituto-padre-arlindo">
            ...
            if ($image) :
                $image_url = $image['url'];
                $image_alt = $image['alt']; ?>
            <img class="image-instituto-padre-arlindo" src="<?php echo esc_url($image_url); ?>"
                alt="<?php echo esc_attr($image_alt); ?>">
            <?php endif; ?>
            <?php
            $link = get_field('link_instituto_padre_arlindo');
            ...
            ?>
            <a class="button link-instituto-padre-arlindo-mobile gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
    ...
    <section class="associacao-superacao" id="associacao-superacao">
        ...
        <div class="box-conteudo-left">
            ...
            <h2 class="titulo-associacao-superacao terminal-test">
                <?php echo get_field('titulo_associacao_superacao'); ?></h2>
            ...
            if ($link) :
                ...
                $gtm_link_associacao = strtolower(str_replace(' ', '-', $link_title));
            ?>
            <a class="button link-associacao-superacao-desktop gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
        ...
        <div class="box-conteudo-right box-conteudo-right-associacao-superacao">
            ...
            if ($image) :
                $image_url = $image['url'];
                $image_alt = $image['alt']; ?>
            <img class="image-associacao-superacao" src="<?php echo esc_url($image_url); ?>"
                alt="<?php echo esc_attr($image_alt); ?>">
            <?php endif; ?>
            <?php
            $link = get_field('link_associacao_superacao');
            ...
            ?>
            <a class="button link-associacao-superacao-mobile gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
    ...
    <section class="escola-formacao-due" id="escola-formacao-due">
        ...
        <div class="box-conteudo-left">
            ...
            <h2 class="titulo-escola-formacao-due terminal-test">
                <?php echo get_field('titulo_escola_de_formacao_due'); ?></h2>
            <div class="descricao-escola-formacao-due"><?php echo get_field('descricao_escola_de_formacao_due'); ?>
            </div>
            <?php
            ...
            ?>
            <a class="button link-escola-desktop gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
        ...
        <div class="box-conteudo-right box-conteudo-right-escola">
            ...
            if ($image) :
                $image_url = $image['url'];
                $image_alt = $image['alt']; ?>
            <img class="image-escola-formacao-due" src="<?php echo esc_url($image_url); ?>"
                alt="<?php echo esc_attr($image_alt); ?>">
            <?php endif; ?>
            <?php
            $link = get_field('link_escola_de_formacao_due');
            ...
            ?>
            <a class="button link-escola-mobile gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
    ...
    <section class="incentivo-empreendedorismo" id="incentivo-empreendedorismo">
        ...
        <div class="box-conteudo-left">
            ...
            <h2 class="titulo-incentivo-empreendedorismo terminal-test">
                <?php echo get_field('titulo_incentivo_ao_empreendedorismo'); ?></h2>
            <div class="descricao-incentivo-empreendedorismo">
                <?php echo get_field('descricao_incentivo_ao_empreendedorismo'); ?></div>
            <?php
            ...
            ?>
            <a class="button link-empreendedorismo-desktop gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
        ...
        <div class="box-conteudo-right box-conteudo-right-incentivo-empreendedorismo">
            ...
            if ($link) :
                ...
                $gtm_link_empreendedorismo = strtolower(str_replace(' ', '-', $link_title));
            ?>
            <a class="button link-empreendedorismo-mobile gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
    ...
    <section class="proposito" id="proposito">
        ...
        <div class="box-conteudo-left">
            ...
            ?>
            <a class="button link-proposito link-proposito-desktop gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
        ...
        <div class="box-conteudo-right box-conteudo-right-proposito">
            ...
            if ($image) :
                $image_url = $image['url'];
                $image_alt = $image['alt']; ?>
            <img class="image-proposito" src="<?php echo esc_url($image_url); ?>"
                alt="<?php echo esc_attr($image_alt); ?>">
            <?php endif; ?>
            <?php
            $link = get_field('link_proposito');
            if ($link) :
                ...
                $gtm_link_proposito = strtolower(str_replace(' ', '-', $link_title));
            ?>
            <a class="button link-proposito-mobile gtm-<?php echo esc_attr($gtm_link_associacao); ?>"
                href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
            ...
            <div class="box-repetidor-selos">
                ...
                <div class="lista-selos-desktop">
                    <div class="box-titulo-svg">
                        ...
                        <h3 class="titulo-card terminal-test">
                            <?php echo get_sub_field('titulo_card_selos_certificacoes'); ?></h3>
                    </div>
                    ...
                    <div class="lista-selos-mobile">
                        <div class="box-titulo-accordion">
                            <h3 class="titulo-card terminal-test">
                                <?php echo get_sub_field('titulo_card_selos_certificacoes'); ?></h3>
                            <svg class="svg-faq" width="19" height="10" viewBox="0 0 19 10" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g id="Arrow - Up 2">
                                    <path id="Stroke 1" d="M1.91927 1.2085L9.5026 8.79183L17.0859 1.2085"
                                        stroke="#002B36" stroke-width="1.95" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </g>
                            </svg>
                        </div>
                        <div class="hover-descricao-mobile">
                            <p class="founders-grotesk"><?php echo get_sub_field('descricoes_selos_e_certificacoes'); ?>
                            </p>
                        </div>
                    </div>
                </div>
