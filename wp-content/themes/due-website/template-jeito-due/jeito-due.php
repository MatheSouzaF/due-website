...
<div class="page-jeito-due">
    ...
    <section class="banner-jeito-due">
        ...
        <div class="box-video">
            <video class="imgGrow" autoplay="autoplay" src="<?php echo get_field('video_jeito_due') ?>" muted loop
                play></video>
        ...
        <div class="box-youtube-vivencie" id="youtube">
            ...
            <svg class="svg-close" width="42" height="42" viewBox="0 0 42 42" fill="none"
            ...
            <div class="my-video" id="my-video">
                <iframe id="youtube-player" src="<?php echo $video ?>" frameborder="0" allow="autoplay; encrypted-media"
    ...
    <section class="proposito-jeito-due">
        <div class="wrapper">
            <div class="box-texto">
                <h2 class="titulo-proposito-jeito-due terminal-test">
                    <?php echo get_field('titulo_proposito_jeito_due'); ?></h2>
            </div>
                ...
                <div class="container-text">
                    ...
                    <div class="box-svg-text">
                        ...
                        <div class="box-repeater">
                            <h3 class="titulo-repetidor">
                                <?php echo get_sub_field('titulo_repetidor_proposito_jeito_due'); ?></h3>
                            <p class="text-box-repeater founders-grotesk">
                                <?php echo get_sub_field('descricao_repetidor_proposito_jeito_due'); ?></p>
                        </div>
                        <?php endwhile;
                        endif; ?>
                    </div>
                    <div class="repetidor-accordion">
                        ...
                        <div class="box-card-faq">
                            <div class="title-svg">
                                ...
                                <i class="svg-proposito">
                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                        ...
                                        <path d="M8.70768 10.604L12.4993 14.3957L16.291 10.604" stroke="black"
                            ...
                            <div id="descwrapper" class="desWrapper">
                                <div class="description-off founders-grotesk">
                                    <?php echo get_sub_field('descricao_accordion') ?></div>
    ...
    <section class="nossa-politicas">
        <div class="wrapper-politicas">

            <div class="box-conteudo">

                <h2 class="titulo-nossa-politicas terminal-test">
                    <?php echo get_field('titulo_nossa_politica'); ?>
                </h2>
                <div class="descricao-nossa-politicas founders-grotesk">
                    <?php echo get_field('descricao_nossa_politica'); ?>
                </div>

                <div class="box-repetidor">
                    <?php
                    if (have_rows('repetidor_nossa_politica')) :
                        while (have_rows('repetidor_nossa_politica')) : the_row(); ?>
                    <div class="row-textos">
                        <i>
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path id="Vector"
                                    d="M8.7536 13.4375L11.5634 16.25L16.2465 9.6875M23.7393 12.5C23.7393 13.9774 23.4486 15.4403 22.8838 16.8052C22.319 18.1701 21.4911 19.4103 20.4474 20.4549C19.4037 21.4996 18.1647 22.3283 16.8011 22.8936C15.4375 23.459 13.976 23.75 12.5 23.75C11.0241 23.75 9.56255 23.459 8.19894 22.8936C6.83533 22.3283 5.59632 21.4996 4.55265 20.4549C3.50899 19.4103 2.68111 18.1701 2.11628 16.8052C1.55145 15.4403 1.26074 13.9774 1.26074 12.5C1.26074 9.51631 2.44488 6.65483 4.55265 4.54505C6.66043 2.43526 9.51919 1.25 12.5 1.25C15.4809 1.25 18.3396 2.43526 20.4474 4.54505C22.5552 6.65483 23.7393 9.51631 23.7393 12.5Z"
                                    stroke="#003B4B" stroke-width="1.125" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                        </i>
                        <p class="texto-repetidor founders-grotesk">
                            <?php echo get_sub_field('texto_repetidor'); ?>
                        </p>
                    </div>
                    <?php endwhile;
                    endif; ?>
            ...
            <div class="box-img">
                <?php
                $image = get_field('imagem_nossa_politica');
                if ($image) :
                    $image_url = $image['url'];
                    $image_alt = $image['alt']; ?>
                <img src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($image_alt); ?>">
    ...
    <section class="big-numeros">
        ...
        <div class="box-image-big-numeros">
            ...
            if ($image) :
                $image_url = $image['url'];
                $image_alt = $image['alt']; ?>
            <img class="img-path-big-numeros" src="<?php echo esc_url($image_url); ?>"
            ...
            <div class="box-card-big-numeros">
                ...
                <div class="lista-big-numeros">
                    <h4 class="titulo-card-big-numeros terminal-test"><?php echo get_sub_field('titulo_big_numeros'); ?>
                    </h4>
                    <p class="descricao-card-big-numeros founders-grotesk">
                        <?php echo get_sub_field('descricao_big_numeros'); ?></p>
                </div>
                <?php endwhile;
                endif; ?>
            </div>
    ...
    <section class="reducao-social">
        <div class="container-social">
            ...
            <div class="box-texto-reducao-social">
                <h2 class="titulo-reducao-social terminal-test">
                    <?php echo get_field('titulo_reducao_das_diferencas_sociais'); ?></h2>
    ...
    <section class="card-repetidor">
        <div class="wrapper">
            ...
            <p class="subtitulo-card-iniciativas founders-grotesk">
                <?php echo get_field('subtitulo_cards_iniciativas'); ?></p>
        </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="lista-card swiper-slide <?php echo $card_class; ?>">
                    <div class="box-texto">
                        ...
                        <a class="button-v2" href="<?php echo esc_url($link_url); ?>"
    ...
    <section class="sintta-stay">
        <div class="box-conteudo-sintta">
            ...
            if ($link) :
                ...
                $link_title = $link['title'];
                $link_target = $link['target'] ? $link['target'] : '_self'; ?>
            <a class="button gtm-sintta-stay-jeito-due" href="<?php echo esc_url($link_url); ?>"
                target="<?php echo esc_attr($link_target); ?>">
                <p class=""><?php echo esc_html($link_title); ?></p>
            </a>
            <?php endif; ?>
